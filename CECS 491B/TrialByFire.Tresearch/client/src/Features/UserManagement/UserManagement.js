...
function UserManagement() {
    ...
    const onSubmitHandler = (e) => {
        ...
        if(handleInput()){
            setAlertData({message: ''})
            axios.post('http://trialbyfiretresearchwebapi.azurewebsites.net//UserManagement/createAccount?username=' + accountData.username.toLowerCase() + '&passphrase=' + hashInput(accountData.Passphrase) + '&authorizationLevel=' + accountData.AuthorizationLevel )
            .then(res => {

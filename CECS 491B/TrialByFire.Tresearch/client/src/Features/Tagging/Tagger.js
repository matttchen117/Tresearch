...
class Tagger extends React.PureComponent{
  ...
  GetTagData = async () => {
    ...
    // Post request
    await axios.post("http://trialbyfiretresearchwebapi.azurewebsites.net//Tag/nodeTagList", this.state.nodes)
    .then(response => {
      // Data from post
      ...
      axios.get("http://trialbyfiretresearchwebapi.azurewebsites.net//Tag/taglist", {})
        .then(response => {
  ...
  handleSelection = (e) => {
    ...
    // Add tag from node(s)
    axios.post("http://trialbyfiretresearchwebapi.azurewebsites.net//Tag/addTag?tagName="+this.handleEncoded(value) ,this.state.nodes)
        .then((response => {
  ...
  handleClick = (e) => {
    ...
    axios.post("http://trialbyfiretresearchwebapi.azurewebsites.net//Tag/removeTag?tagName="+this.handleEncoded(value), this.state.nodes)
        .then(response => {
            this.setState( previousState => ({

...
{
    public class CreateNodeResponse<T> : IResponse<T>
    {
        ...
        ///         Constructor for CreateNodeResponse objects
        /// </summary>
        ...
        public CreateNodeResponse(string errorMessage, T? data, int statusCode, bool isSuccess)
        {
        ...
        /// <summary>
        ///     Equals:
        ///         overriden equals method to compare CreateNodeResponse's (mainly for testing purposes)
        /// </summary>
        ...
        public override bool Equals(object? obj)
        {
            if (!(obj == null))
            {
                if (obj is CreateNodeResponse<T>)
                {
                    CreateNodeResponse<T> response = (CreateNodeResponse<T>)obj;

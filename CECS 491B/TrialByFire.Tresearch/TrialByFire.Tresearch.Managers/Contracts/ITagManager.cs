...
namespace TrialByFire.Tresearch.Managers.Contracts
{
    public interface ITagManager
    {
        ...
        public Task<Tuple<List<ITag>, string>> GetTagsAsync(string order, CancellationToken cancellationToken = default(CancellationToken));
        public Task<Tuple<List<ITag>, string>> GetPossibleTagsAsync(List<long> nodeIDs, CancellationToken cancellationToken = default(CancellationToken));
    }
}

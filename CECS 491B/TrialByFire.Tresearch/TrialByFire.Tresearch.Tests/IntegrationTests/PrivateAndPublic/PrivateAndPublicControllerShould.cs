...
namespace TrialByFire.Tresearch.Tests.IntegrationTests.PrivateAndPublic
{
    ...
    public class PrivateAndPublicControllerShould : TestBaseClass
    {


        
        private IPrivateAndPublicController _privateAndPublicController;
        public PrivateAndPublicControllerShould() : base(new string[] { })
        {
        ...
        public async Task PublicNodeAsync(IRoleIdentity roleIdentity, List<long> nodes, IResponse<string> expected)
        {
            ...
            // Act
            ActionResult<string> response = await _privateAndPublicController.PublicNodeAsync(nodes);

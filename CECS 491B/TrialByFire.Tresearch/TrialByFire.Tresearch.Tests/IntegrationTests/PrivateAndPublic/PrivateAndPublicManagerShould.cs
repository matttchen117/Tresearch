...
namespace TrialByFire.Tresearch.Tests.IntegrationTests.PrivateAndPublic
{
    ...
    public class PrivateAndPublicManagerShould : TestBaseClass
    {

        private IPrivateAndPublicManager _privateAndPublicManager;
        public PrivateAndPublicManagerShould() : base(new string[] { })
        {
        ...
        public async Task PrivateNodeAsync(IRoleIdentity roleIdentity, List<long> nodes, IResponse<string> expected)
        {
            ...
            // Act
            IResponse<string> response = await _privateAndPublicManager.PrivateNodeAsync(nodes);
        ...
        public async Task PublicNodeAsync(IRoleIdentity roleIdentity, List<long> nodes, IResponse<string> expected)
        {
            ...
            // Act
            IResponse<string> response = await _privateAndPublicManager.PublicNodeAsync(nodes);

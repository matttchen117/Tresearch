...
{
    public class CopyAndPasteServiceShould : TestBaseClass
    {
        private ICopyAndPasteService _copyAndPasteService;

        public CopyAndPasteServiceShould() : base(new string[] { })
        {
        ...
        public static IEnumerable<object[]> CopyNodeData()
        {
            ...
            var nodesCopiedList0 = new List<Node>();
            IResponse<IList<Node>> nodesCopiedResult0 = new CopyResponse<IList<Node>>("401: Server: No active session found. Please login and try again.", nodesCopiedList0, 400, false);
            ...
            var nodesCopiedList1 = new List<Node>();
            IResponse<IList<Node>> nodesCopiedResult1 = new CopyResponse<IList<Node>>("400: Server: No nodes to copy failure", nodesCopiedList1, 400, false);

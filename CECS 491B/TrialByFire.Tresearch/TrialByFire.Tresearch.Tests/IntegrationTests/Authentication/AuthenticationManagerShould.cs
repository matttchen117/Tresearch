...
namespace TrialByFire.Tresearch.Tests.IntegrationTests.Authentication
{
    public class AuthenticationManagerShould : TestBaseClass
    {
        ...
        [InlineData("sarry@gmail.com", "abcdef123", "admin", "guest", "guest", "", 2022, 3, 4, 5, 6, 0, "400: Data: Invalid Username or OTP. " +
            "Please try again.")]
        [InlineData("sarry@gmail.com", "abc", "admin", "guest", "guest", "", 2022, 3, 4, 5, 6, 0, "400: Data: Invalid Username or OTP. " +
            "Please try again.")]
        [InlineData("sarry@gmail.com", "abcdef#$%", "admin", "guest", "guest", "", 2022, 3, 4, 5, 6, 0, "400: Data: Invalid Username or OTP. " +
            "Please try again.")]
        ...
        [InlineData("rarry@gmail.com", "abcdef123", "user", "guest", "guest", "", 2022, 3, 4, 5, 6, 0, "400: Database: Too many fails have occurred. " +
        ...
        [Theory]
        [InlineData("garry@gmail.com", "ABCdef123", "user", "guest", "guest", "", 2022, 3, 4, 5, 6, 0, "200: Server: Authentication success.")]
        [InlineData("garry@gmail.com", "ABCdef123", "user", "garry@gmail.com", "user", "8C89E7886643911D171624EEFDF875F6B45C0052A761A6A713E9D26EFCF66F9D47ADD4899E98C6A8525CCB7D68F9BAB1EF1A75D4F1558726103FF0BE7B6A32B2", 2022, 3, 4, 5, 6, 0, "403: Server: Active session found. Please logout and try again.")]

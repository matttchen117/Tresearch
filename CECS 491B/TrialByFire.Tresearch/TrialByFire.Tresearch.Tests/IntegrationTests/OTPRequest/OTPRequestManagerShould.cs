...
{
    public class OTPRequestManagerShould : TestBaseClass
    {
        public OTPRequestManagerShould() : base(new string[] { })
        {
        ...
        public async Task RequestTheOTP(string username, string passphrase, string authorizationLevel, 
        ...
        [InlineData("earry@gmail.com", "abcDEF123", "user", "guest", "guest", "", "401: Database: Please confirm your " +
            "account before attempting to login.")]
        public async Task RequestTheOTPWithin5Seconds(string username, string passphrase, 
            string authorizationLevel, string currentIdentity, string currentRole, 

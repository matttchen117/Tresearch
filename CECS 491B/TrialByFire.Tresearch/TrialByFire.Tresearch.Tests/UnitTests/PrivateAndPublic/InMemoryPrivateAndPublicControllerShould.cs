...
{
    public class InMemoryPrivateAndPublicControllerShould : TestBaseClass
    {

        private IPrivateAndPublicController _privateAndPublicController;

        public InMemoryPrivateAndPublicControllerShould() : base(new string[] { })
        {
            TestServices.AddScoped<ISqlDAO, InMemorySqlDAO>();
            TestServices.AddScoped<IPrivateAndPublicService, PrivateAndPublicService>();
            TestServices.AddScoped<IPrivateAndPublicManager, PrivateAndPublicManager>();
            TestServices.AddScoped<IPrivateAndPublicController, PrivateAndPublicController>();
            TestProvider = TestServices.BuildServiceProvider();
            _privateAndPublicController = TestProvider.GetService<IPrivateAndPublicController>();
        }
        ...
        public async Task PrivateNodeAsync(IRoleIdentity roleIdentity, List<long> nodes, IResponse<string> expected)
        {
            ...
            // Act
            ActionResult<string> response = await _privateAndPublicController.PrivateNodeAsync(nodes);
        ...
        //i need to split this up, but since i pass a list of nodes i have to use memberData
        ...
        public async Task PublicNodeAsync(IRoleIdentity roleIdentity, List<long> nodes, IResponse<string> expected)
        {
            ...
            // Act
            ActionResult<string> response = await _privateAndPublicController.PublicNodeAsync(nodes).ConfigureAwait(false);
        ...
        public static IEnumerable<object[]> PublicNodeData()
        {
            ...
            IRoleIdentity roleIdentity1 = new RoleIdentity(true, "grizzly@gmail.com", "user", "87ec69f0ab41c3dcb31e01dcf9942d756501b421887524a1e691dff69a698cf1d46c26b68f73dddb29a7d2729eddf43580bab9a5002d2289c0c7bf4d5db7c7ae");
            var nodesToPrivate1 = new List<long> { 1, 2, 3 };
            IResponse<string> nodesPrivateResult1 = new PrivateResponse<string>("200: Server: Public Node Success", null, 200, true);

...
{
    public class InMemoryPrivateAndPublicManagerShould : TestBaseClass
    {
        private IPrivateAndPublicManager _privateAndPublicManager;

        public InMemoryPrivateAndPublicManagerShould() : base (new string[] { })
        {
            ...
            _privateAndPublicManager = TestProvider.GetService<IPrivateAndPublicManager>();
        }
        ...
        public async Task PrivateNodeAsync(IRoleIdentity roleIdentity, List<long> nodes, IResponse<string> expected)
        {
            ...
            // Act
            IResponse<string> response = await _privateAndPublicManager.PrivateNodeAsync(nodes).ConfigureAwait(false);
        ...
        public async Task PublicNodeAsync(IRoleIdentity roleIdentity, List<long> nodes, IResponse<string> expected)
        {
            ...
            // Act
            IResponse<string> response = await _privateAndPublicManager.PublicNodeAsync(nodes).ConfigureAwait(false);

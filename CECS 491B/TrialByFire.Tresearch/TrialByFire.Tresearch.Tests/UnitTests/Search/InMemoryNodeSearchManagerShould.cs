...
{
    public class InMemoryNodeSearchMangagerShould : TestBaseClass
    {
        private INodeSearchManager _nodeSearchManager;
        public InMemoryNodeSearchMangagerShould() : base(new string[] { })
        {
            ...
            _nodeSearchManager = TestProvider.GetService<INodeSearchManager>();
        }

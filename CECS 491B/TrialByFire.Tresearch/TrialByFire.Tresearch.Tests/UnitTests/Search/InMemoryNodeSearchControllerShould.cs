...
{
    public class InMemoryNodeSearchControllerShould : TestBaseClass
    {
        private INodeSearchController _nodeSearchController;
        public InMemoryNodeSearchControllerShould() : base(new string[] { })
        {
            ...
            Thread.CurrentPrincipal = new RolePrincipal(new RoleIdentity(true, "guest", "guest", "E64C56A055B741393268F7EE26EF3AA00FC58D6272C06DE31932B71EB965A68CCB9F32AEBD74E25708AD501C7D7AAA1E5C4CE4C9010149FBA08B2C5351A57F34"));
        }

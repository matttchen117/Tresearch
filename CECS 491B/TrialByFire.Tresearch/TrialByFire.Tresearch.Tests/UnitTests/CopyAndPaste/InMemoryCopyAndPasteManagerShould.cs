...
{
    public class InMemoryCopyAndPasteManagerShould : TestBaseClass
    {
        private ICopyAndPasteManager _copyAndPasteManager;
        public InMemoryCopyAndPasteManagerShould() : base(new string[] { })
        {
        ...
        public static IEnumerable<object[]> CopyNodeData()
        {
            ...
            IList<Node> nodesCopiedList2 = new List<Node> { node1, node2 };
            IResponse<IList<Node>> nodesCopiedResult2 = new CopyResponse<IList<Node>>("503: Database: Mismatched amount of nodes returned", nodesCopiedList2, 400, false);
            */

...
{
    public class InMemoryCopyAndPasteServiceShould : TestBaseClass
    {
        private ICopyAndPasteService _copyAndPasteService;
        public InMemoryCopyAndPasteServiceShould() : base(new string[] { })
        {
            ...
            _copyAndPasteService = TestProvider.GetService<ICopyAndPasteService>();
        ...
        public async Task CopyNodeAsync(IRoleIdentity roleIdentity, List<long> nodesCopy, IResponse<IList<Node>> expected)
        {
            ...
            // Act
            IResponse<IEnumerable<Node>> response = await _copyAndPasteService.CopyNodeAsync(nodesCopy).ConfigureAwait(false);
        ...
        public async Task PasteNodeAsync(IAccount account, string userHash, long nodeIDToPasteTo, List<INode> nodes, IResponse<string> expected)
        {
            ...
            // Act
            ActionResult<string> response = await _copyAndPasteService.PasteNodeAsync(nodeIDtoPasteTo, nodes).ConfigureAwait(false);
        ...
        public static IEnumerable<object[]> PasteNodeData()
        {
            ...
            IAccount account0 = new UserAccount("grizzly@gmail.com", "asdfasdf", "user", true, true);
            IAccount account1 = new UserAccount("salewa@gmail.com", "asdfasdf123", "admin", true, true);
            IAccount account2 = new UserAccount("trizip@gmail.com", "asdfasdf", "user", true, true);


            IList<Node> nodes0 = new List<Node>();
            IList<Node> nodes1 = new List<Node> { node1, node2, node3 };



            string userHash0 = "0B1CC9CFB7380E8E7A80726D12CB997C936D95B514E7F921187119FD80996BBACA103C08EFCC39553EFF5DFC368D4D8D197C9080C7015AE4DA2E87884E7DE9A6";

            long nodeIDToPasteTo0 = 7;
            long nodeIDToPasteTo1 = 8;
            long nodeIDToPasteTo2 = 9;
            ...
            return new[]
            {
                new object[] { account0, userHash0, nodeIDToPasteTo0, nodes0}
            };

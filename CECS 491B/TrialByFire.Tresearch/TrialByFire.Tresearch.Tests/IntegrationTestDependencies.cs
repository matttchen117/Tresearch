...
namespace TrialByFire.Tresearch.Tests
{
    public class IntegrationTestDependencies
    {
        ...
        private string _connectionString = "Data Source=tresearchtesting.database.windows.net;Initial Catalog=testing;User ID=tresearchadmin;Password=CECS491B!;Connect Timeout=30;Encrypt=True;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";

...
namespace TrialByFire.Tresearch.Tests
{
    public class IntegrationTestDependencies
    {
        ...
        private string _connectionString = "Data Source=tresearchstudentserver.database.windows.net;User ID=tresearchadmin;Password=CECS491B!;Connect Timeout=30;Encrypt=True;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
